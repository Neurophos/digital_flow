# RegTool
NOTE: This page and images were copied from: 

https://github.com/lowRISC/opentitan/blob/master/util/reggen/README.md
...
A description of Hjson (a variant of JSON) and the recommended style is in the [Hjson Usage and Style Guide](https://github.com/lowRISC/opentitan/blob/master/doc/contributing/style_guides/hjson_usage_style.md)
...
For more detail on the non-register entries of the Hjson configuration file, see [this section](https://github.com/lowRISC/opentitan/blob/master/doc/contributing/hw/comportability/README.md#configuration-description-hjson)
of the Comportability Specification.
...
The output is two Verilog files that can be instantiated by a peripheral that follows the [Comportability Guidelines](https://github.com/lowRISC/opentitan/blob/master/doc/contributing/hw/comportability/README.md#configuration-description-hjson)
...
![subreg_rw](./images/subreg_rw.svg)
...
![subreg_ext](./images/subreg_ext.svg)
...
![subreg_rw1c](./images/subreg_rw1c.svg)

![subreg_rw0c](./images/subreg_rw0c.svg)

![subreg_rw1s](./images/subreg_rw1s.svg)
...
![subreg_shadow](./images/subreg_shadow.svg)
